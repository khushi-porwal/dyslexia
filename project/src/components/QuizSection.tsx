...
const allQuestions = [
  ...
  },
  {
    ...
    options: ["Reading Books", "Watching Videos", "Playing Games", "Doing Experiments"],
  },
  {
    id: 7,
    question: "If you could talk to animals, which would you talk to first?",
    options: ["Dogs", "Birds", "Dolphins", "Lions"],
  },
  {
    id: 8,
  ...
  {
    id: 9,
    question: "If you could have any magical object, what would it be?",
    options: ["Magic Wand", "Flying Carpet", "Invisibility Cloak", "Time Turner"],
  },
  {
    id: 10,
